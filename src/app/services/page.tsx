        ...
        <AccordionContent>
          <ul className='list-inside list-disc'>
            {service.description.map((desc, index) => (
              <li key={index} className='text-zinc-700 text-lg font-normal leading-[25px]'>{desc}</li>
            ))}
          </ul>
        </AccordionContent>
      </AccordionItem>
...
<div className="flex gap-5 justify-end flex-col-reverse md:flex-row my-[104px]">
      ...
      <h2 className='text-neutral-800 text-[40px]'>Proudly helping businesses</h2>
      ...
      <Button
            ...
            >
              View our portfolio<Image src={arrow} alt="" className="arrow" />
            </Button>
    </div>
      </div>
    </div>
